            ...
            <div class="hidden sm:block w-full overflow-x-auto rounded-lg">
                <table class="min-w-full text-left border-collapse">
                    <thead class="bg-gray-100 text-gray-700 text-sm uppercase">
                        <tr>
                            <th class="py-3 px-4 font-medium whitespace-nowrap">Title</th>
                            @if (auth()->user()->role == 'admin' || auth()->user()->role == 'super_admin')
                                <th class="py-3 px-4 text-center font-medium whitespace-nowrap">App No</th>
                            @endif
                            <th class="py-3 px-4 text-center font-medium whitespace-nowrap">Date Submitted</th>
                            <th class="py-3 px-4 text-center font-medium whitespace-nowrap">Reviewer Status</th>
                            <th class="py-3 px-4 text-center font-medium whitespace-nowrap">Status</th>
                            <th class="py-3 px-4 text-center font-medium whitespace-nowrap">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <div class="flex flex-col gap-2 md:flex-row md:justify-between md:items-start">
                            ...
                            <div class="flex gap-2 mt-2 md:mt-0">
                                <a href="/{{ auth()->user()->role }}/application/{{ $application->id }}"
                                    class="text-white bg-[#325AB3] hover:bg-[#274894] text-xs px-4 py-2 rounded-md transition min-w-[64px] text-center">
                                    View
                                </a>
                                <a href="{{ asset('storage/' . $application->attachment) }}" target="_blank"
                                    class="text-[#325AB3] border border-[#325AB3] hover:bg-[#325AB3] hover:text-white text-xs px-4 py-2 rounded-md transition min-w-[64px] text-center">
                                    File
                                </a>
                            </div>
                        </div>
