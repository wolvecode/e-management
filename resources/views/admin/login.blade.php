                ...
                <div class="w-full h-100">         
                    ...
                    <form method="POST" action="/admin/login" class="mt-6">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="" placeholder="Enter Email Address" class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-white focus:outline-none" autofocus autocomplete required value="{{old('email')}}"" />
                            @error('email')
                        ...
                        <div class="mt-4">
                            ...
                            <input type="password" name="password" id="" placeholder="Enter Password" minlength="6" class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500
                                focus:bg-white focus:outline-none" required value="{{old('password')}}"" />
                        </div>
