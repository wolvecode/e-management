...
@section('sidebar-item')
    ...
    <li>
        <a href="/application" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-[#325AB3] text-white hover:text-[#34A853] border-l-4 border-transparent hover:border-indigo-500 pl-6 py-8">
            <span class="inline-flex justify-center items-center ml-4">
    ...
    <div class="xl:max-h-[640px] 2xl:max-h-[780px] overflow-y-auto bg-gray-100 rounded-xl px-5 py-3">
        <div class="grid gap-x-4 gap-y-2 lg:grid-cols-4 md:grid-cols-2">
            <div class="text-center bg-[#2640A1] rounded-lg px-4 py-8">
                ...
                <p class="font-semibold text-2xl text-white">2 Applications</p>
            </div>
            <div class="justify-center text-center bg-[#34A853] rounded-lg px-4 py-8">
                ...
                <p class="font-semibold text-2xl text-white">1 Approved</p>
            </div>
            <div class="text-center bg-[#2640A1] rounded-lg px-4 py-8">
                <img class="mx-auto mb-2" width="25px" src="{{ asset('icons/pending.png') }}" alt="profile">
                <p class="font-semibold text-2xl text-white">1 Pending</p>
            </div>
            <div class="text-center bg-[#C63740] rounded-lg px-4 py-8">
                ...
                <p class="font-semibold text-2xl text-white">1 Rejected</p>
            </div>
        </div>

        <div class="bg-white rounded-xl px-5 mt-5 py-3">
            <div class="flex justify-end mt-2">
                <p class="text-sm text-[#2640A1] bg-gray-100 px-5 py-1 rounded-xl">12/08/2023</p>
            </div>
            ...
            <div class="w-5/6 relative pt-1 mx-auto mt-4">
                <div class="overflow-hidden h-2 mb-4 text-xs flex rounded">
                  <div style="width: 25%" class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-[#34A853] mr-2 rounded-xl"></div>
                  <div style="width: 25%" class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-[#34A853] mr-2 rounded-xl"></div>
                  <div style="width: 25%" class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-[#2640A1] mr-2 rounded-xl"></div>
                  <div style="width: 25%" class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-[#2640A1] mr-2 rounded-xl"></div>
                </div>
                <div class="overflow-hidden mb-4 text-xs flex rounded">
                    <div style="width: 25%" class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center text-base text-[#1E1E1E]">Assigned to reviewer</div>
                    <div style="width: 25%" class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center text-base text-[#1E1E1E]">Approved by reviewer</div>
                    <div style="width: 25%" class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center text-base text-[#1E1E1E]">Approved by admin</div>
                    <div style="width: 25%" class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center text-base text-[#1E1E1E]">Completed</div>
                  </div>
            </div>
            <div class="text-right mb-2">
                <a href="" class="text-white text-sm fonts-medium px-3 py-1.5 bg-[#2640A1] rounded">See details</a>
            </div>
        </div>
            ...
            <div class="overflow-y-auto h-62 mt-2">
                <div class="w-full rounded-xl px-4 shadow-lg flex items-center mt-4 pb-2">
                    <div class="w-2/12 flex items-center">
                        ...
                        <h4 class="text-sm fonts-semibold">Martha Johnson</h4>
                    </div>
                    <div class="w-4/12">
                        <p class="truncate border-l pl-5 text-sm fonts-medium">Lorem ipsum dolor sit amet consectetur adipisicing elit. In perferendis eaque praesentium numquam dolorem repellendus aliquid libero accusamus, blanditiis distinctio soluta, necessitatibus aspernatur sed dolorum quo? Libero vel eligendi laborum ipsam cumque dolores minus suscipit ut quae sequi debitis, quaerat incidunt vitae tempora perspiciatis error doloribus soluta dolorem assumenda corporis aliquam accusantium. Quod, delectus. Odio voluptate rerum sint veniam excepturi quam ad vero adipisci qui? Sunt et animi deserunt dolorem consequuntur iure dolore nisi omnis. Fugiat, consequatur consequuntur sapiente ipsam sequi, error dicta porro cum fugit assumenda neque natus quidem excepturi hic voluptate. Dolores alias consectetur suscipit ipsa accusamus a necessitatibus deleniti quisquam, sit velit beatae hic saepe ullam assumenda quasi incidunt numquam voluptas repellat facere pariatur distinctio laboriosam! Dicta amet magnam veniam, placeat, eum cupiditate sed quae aliquid non dolorem ad repellat praesentium quisquam pariatur exercitationem commodi inventore tenetur, qui quam libero reprehenderit possimus in. Fugit nemo quod culpa omnis, aspernatur nam quidem enim quisquam cumque! Ad cumque sit eaque commodi architecto non possimus neque dicta. Veritatis excepturi, facere possimus quibusdam perspiciatis obcaecati ad sapiente explicabo a libero sequi, consequatur odit vitae reiciendis quod? Nemo, voluptate blanditiis illum rerum culpa, ea vel quasi animi, voluptatum qui soluta at officiis.</p>
                    </div>
                    <div class="w-2/12 text-center border-l px-2">
                        <p class="text-sm fonts-medium">20/10/2023</p>
                    </div>
                    <div class="w-2/12 text-center border-l pl-5">
                        <a class="pointer-events-none text-sm fonts-medium px-3 py-1.5 bg-gray-100 text-[#C63740] rounded-lg">Pending</a>
                    </div>
                    <div class="w-2/12 text-center border-l px-2">
                        <a href="" class="text-white text-sm fonts-medium px-2 py-1 bg-[#2640A1] rounded">See details</a>
                    </div>
                </div>
                <div class="w-full rounded-xl px-4 shadow-lg flex items-center mt-4 pb-2">
                    <div class="w-2/12 flex items-center">
