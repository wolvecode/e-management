                ...
                <form method="POST" action="/{{ basename($_SERVER['REQUEST_URI']) }}/login">
                    ...
                    <div class="mt-10 mr-10">
                        ...
                        <div class="flex justify-center mt-5">
                            <button type="submit"
                                class="bg-[#304CB0] text-[#FFF] fonts-medium text-2xl px-6 py-2 rounded">Sign In</button>
                        </div>

                        <div class="flex justify-center text-sm mt-2">
                            <span class="">Forget password:&nbsp;</span> <a class="text-red-400 underline"
                                href="/forget-password">reset</a>
                        </div>
                ...
                <form method="POST" action="/{{ basename($_SERVER['REQUEST_URI']) }}/register">
                    ...
                    <div class="ml-10 mt-10">
                        <label class="block mt-3">
                            ...
                            focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm 
                            focus:ring-1"
                                placeholder="Enter FullName" value="{{ old('name') }}" />
                            @error('name')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </label>
                        <label class="block mt-3">
                            ...
                            focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm 
                            focus:ring-1"
                                placeholder="Enter FullName" value="{{ old('email') }}" />
                            @error('email')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </label>
                        ...
                        <div class="flex relative mt-5">
                            ...
                            <p class="-mt-px text-sm">I agree to the Terms of Service and acknowledge the Privacy Policy.
                            </p>
                        </div>
